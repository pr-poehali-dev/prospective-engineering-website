        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-[#4A4A52]/70 leading-relaxed text-lg">
                Институт перспективного машиностроения "Ростсельмаш" (передовая
                инженерная школа ДГТУ) — твой путь к карьере в крупнейшей
                машиностроительной компании России. Изучай передовые технологии,
                работай на современном оборудовании, получай гарантированное
                трудоустройство.
              </p>
            </div>

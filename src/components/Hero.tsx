          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-[#4A4A52]/70 leading-relaxed text-lg">
                ...
                инженерная школа ДГТУ) — твой путь к карьере в крупнейших
                машиностроительных компаниях России. Изучай передовые
                технологии, работай на современном оборудовании, получай
